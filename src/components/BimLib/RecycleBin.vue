<template>
    <section class="main">
        <div class="drag-box-left">
            ...
            <div class="drag-list" draggable="true" v-for="list in data1" :data-id="list.id" @dragstart="dragstartEvent"  :key="list.id" @dragenter="dragenterEvent" @dragleave="dragleaveEvent" @dragover="dragoverEvent">{{list.title}}</div>
        </div>
        <div class="drag-box-right">
            <div class="drag-title">已完成</div>
            <div class="drag-list" draggable="true" v-for="list in data2" :data-id="list.id" @dragstart="dragstartEvent"  :key="list.id" @dragend="dragendEvent" @dragenter="dragenterEvent" @dragleave="dragleaveEvent" @dragover="dragoverEvent">{{list.title}}</div>
        </div>
