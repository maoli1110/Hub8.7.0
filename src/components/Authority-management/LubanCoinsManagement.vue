    ...
    <div class="LubanCoinsManagementBox">
        ...
        <div class="header" style="margin-bottom:20px;box-shadow: 1px 1px 5px #ccc;">
            ...
            <el-col :span="8" class="pull-right-btn">
           		<el-button type="primary" class="basic-btn" >分配鲁班币</el-button>
           		<el-button type="primary" class="basic-btn" @click="dialogVisible=true">立即充值</el-button>
            </el-col>
        </div>
        <div class="header" >
            <el-col :span="24">
                <span class="orders-text font-w-n font-s-12">查询时间范围：</span>
        ...
        <div class="main">
            <vue-scrollbar class="my-scrollbar" ref="VueScrollbar">
                <el-table ref="multipleTable scroll-me" :data="coinsManagementTableData" border tooltip-effect="dark"
                    ...
                    <el-table-column class="table-tr" prop="disbursement" label="支出（个）" width="200"></el-table-column>
