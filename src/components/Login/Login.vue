                ...
                <div class="form">
                    <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px" class="demo-ruleForm">
                        <el-form-item prop="username" style="position:relative">
                            ...
                            <el-input v-model="loginForm.username" placeholder="username" class="paddingPlaceholder">
                            </el-input>
                        </el-form-item>
                        <el-form-item prop="password" style="position:relative">
                            ...
                            <el-input type="password" placeholder="password" class="paddingPlaceholder" v-model="loginForm.password" @keyup.enter.native="submitForm('ruleForm')">
                            </el-input>
                        </el-form-item>
                        <div class="login-btn">
