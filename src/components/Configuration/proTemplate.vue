            ...
            <el-row class="pro-ztreeInfo clearfix">
                ...
                <el-col :span="14" class="project-form">
                    ...
                    <div style="border:1px solid #ddd;">
                        ...
                        <div class="project-form-ele" v-for='(item,index) in typeList' :key="index" v-show='index==value'>
        ...
        <div class="formEdit" v-show="formEditVisible">
            ...
            <div class="formEdit-body">
                ...
                <div class="formLine">
                    ...
                    <template>
                        <el-tabs v-model="activeName2" type="card" @tab-click="tabClick" v-for='(item,index) in typeList' :key="index" v-show='index==value'>

                            <el-tab-pane :label="childitem.typeName" v-for='(childitem,index) in item.childs' :key="childitem.typeName">
