    ...
    <div class="wrap">
        <div>
            ...
            <div style="margin:10px auto;width:550px;position:relative">
                ...
                <div class="selcetNodes">
                    ...
                    <div class="select-dropdown">
                        <ul>
                            ...
                            <li @click='textAreaVisible = true;textareaValue="";textTittle="增加多个节点";type="node"'>
                                增加多个节点
                ...
                <div>
                    <ul class="tree-operate clearfix">
                        <li @click="add({isParent:false})">
                            <span class="icon-add-status icon"></span>
                            <div>节点</div>
                        </li>
                        <li @click="add({isParent:true})">
                            <span class="icon-add-nodes  icon"></span>
                            <div>状态</div>
                        </li>
                        <li @click="rename()">
                        ...
                        <li @click="remove()">
                            <span class="icon-remove_    icon"></span>
                            <div>删除</div>
                        </li>
                        <li @click="upMove()">
                            <span class="icon-up-move    icon"></span>
                            <div>上移</div>
                        </li>
                        <li @click="downMove()">
                            <span class="icon-down-move  icon"></span>
                            <div>下移</div>
                        </li>
                        <li @click="upLevel()">
                            <span class="icon-up-level   icon"></span>
                            <div>升级</div>
                        </li>
                        <li @click="downLevel()">
                            <span class="icon-down-level icon"></span>
                            <div>降级</div>
                        </li>
                    </ul>
        ...
        <!--增加多个节点/状态弹框-->
        <!-- <el-dialog :title=textTittle :visible.sync="textAreaVisible" custorm-class="project-manage"
