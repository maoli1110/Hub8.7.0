            ...
            <el-row class="process-set">
                            ...
                            <table border="0" cellspacing="0">
                                ...
                                <tr v-for="(rootInfo,index) in rootInfo" :key="index" @click="processSetEdit($event,index)">
                                    ...
                                    <td>
                                        ...
                                        <span class="addRoot substr" v-for="(lines,index) in rootInfo.addRolesLine" :title="lines" :key="index">{{lines}}&nbsp;&nbsp;
                ...
                <el-col :span="10" class="root-name">
                    <div style="padding-right:20px;">
                        <p>审核角色</p>
                        <div class="rules-box">
                            <div class="root-el substr" v-for="(item,index) in rootList" v-text="item.roleName" :key="index" :title="item.roleName" roleId="item.roleId" @click="addRoles(index)"></div>
                        </div>
                    </div>
                </el-col>
            ...
            <el-row class="process-set">
                    ...
                    <div style="padding:0 20px;">
                        ...
                        <div class="table-step">
                            <table border="0" cellspacing="0">
                                ...
                                <tr v-for="(rootInfo,index) in rootInfoEdit.steps" :key="index" @click="eidtProcessSetEdit($event,index)">
                                    <td width="50">{{index+1}}</td>
                                    <td width="210">
                                    ...
                                    <td>
                                        ...
                                        <span class="addRoot substr" v-for="(lines,index) in rootInfo.rootEditArr" :key="index" :title="lines" >{{lines}}&nbsp;&nbsp;
                ...
                <el-col :span="10" class="root-name">
                    <div style="padding-right:20px;">
                        <p>审核角色</p>
                        <div class="rules-box">
                            <div class="root-el substr" v-for="(item,index) in rootList" v-text="item.roleName" :key="index" :title="item.roleName" roleId="item.roleId" @click="eidtAddRoles(index)"></div>
                        </div>
                    </div>
                </el-col>
