<template>
    <div>
        <div class="admin-main">
            ...
            <el-table ref="multipleTable" :data="roleTableData" border tooltip-effect="dark" style="width: 100%;margin-top:20px" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <span type="primary" class="icon-edit_" @click="editRole(scope.row.id)"></span>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="新增管理员" :visible.sync="addAdminDialogVisible" size='add-admin'>
            <div class="el-form-item">
                ...
                <div class="el-form-item__content" style="margin-left: 45px;">
                    <el-select v-model="checkedCities" placeholder="请选择" class="admin-select" multiple @visible-change='visibleChange' @click.native='closeSelect'
                        style="width:100%">
                    ...
                    <div class="el-transfer-panel__body ">
                        <vue-scrollbar class="my-scrollbar" ref="VueScrollbar" style="height:375px;">
                            <el-checkbox-group v-model="checkedPermissions" @change="handleCheckedCitiesChange">
                                <el-checkbox v-for="permission in permissions" :label="permission" :key="permission" :title="permission" class="add-permission-group">{{permission}}
                                </el-checkbox>
                            </el-checkbox-group>
                        </vue-scrollbar>
                    </div>
            ...
            return {
                ...
                roleTableData: [{
                    ...
                    },
                    {
                        ...
                        pass: 55556549894956,
                        date: "2016-05-03 13:51",
                        remarks: "超长remark5555555555555555555555555555555555555555555555555555555555555555555555555555555555555"
                    },
                    {
                        name: "赵四",
                        pass: 55556549894956,
