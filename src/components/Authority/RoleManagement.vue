    ...
    <div>
        <div class="main">
            <div>
                ...
                <el-input placeholder="请输入" v-model="pageParams.searchStr" icon="search" :on-icon-click="search" @keyup.enter.native="search"
                    style="float:right;width:210px"></el-input>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            editRole(row) {
                console.log(row);
                this.$router.push({
                    path: `/authority/edit-role/${row.roleId}`
                });
